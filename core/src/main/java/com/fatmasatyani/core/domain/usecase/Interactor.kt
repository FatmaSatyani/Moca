...
//    override fun getMovie(id: Int) = repository.getMovie(id).asLiveData()
    ...
    override fun addFavoriteMovie(movie: MovieModel) = repository.addFavoriteMovie(movie)

    override fun removeFavoriteMovie(movie: MovieModel) = repository.removeFavoriteMovie(movie)
